	...
	<section id="content">
        ...
        <div class="head-title">
				<div class="left">
					...
					<a href="User.php"><button class="btn btn-light">Retour</button></a>
				</div>
				<a href="#" class="btn btn-dark" data-toggle="modal" data-target="#myModal">
					<i class='bx bxs-cloud-download' ></i>
					&#10133<span class="text">Ajouter un utilisateur</span>
				</a>
			</div>
<!-- 
			<ul class="box-info">
            ...
            <tr>
                ...
                <td><?php echo $row['mdpc']; ?></td>
                <td><?php echo $row['contact']; ?></td>
				<td><span><a data-toggle="modal" href="#myModal<?php echo $row['id_client']; ?>"><img src="assets/img/edit.png" style="width:25px;height:25px;"><i class="ri-edit-line edit"></a></i>
    <!-- <td><button onclick="document.getElementById('id02').style.display='block'"><span><i class="ri-edit-line edit"></i></button> -->
    <a onclick = "sure(<?php echo $row['id_client']; ?>);" href="#"><img src="assets/img/delete.jpg" style="width:25px;height:25px;"><i class="ri-delete-bin-line delete"></i>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="insert/insert_utilisateur.php" method="post">
...
<div class="container mt-3">
 ...
 <div class="modal fade" id="myModal<?php echo $row['id_client']; ?>">
   <div class="modal-dialog">
     <div class="modal-content">
 ...
 <p>
 <input class="form-control" name="uname" id="uname" cols="30" rows="10" value="<?php echo $row['nomc']; ?>"></p>
 <p>
 <input class="form-control" name="mdp" id="mdp" cols="30" rows="10" value="<?php echo $row['mdpc']; ?>"></p>
 <input class="form-control" name="uc" id="uc" cols="30" rows="10" value="<?php echo $row['contact']; ?>"></p>
<br>
<input style="display:none;" class="form-control" name="u_id" id="ingname" cols="30" rows="10" value="<?php echo $row['id_client']; ?>">
<br>
...
function sure(var1) {
    if(confirm("Sure ?")){
        window.location.href = "delete/delete_util.php?id_r=" + var1;
    }
}
