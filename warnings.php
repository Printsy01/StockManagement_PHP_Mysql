...
$stoc = ("SELECT * FROM fournitures WHERE qty <= 3 ORDER BY fournitures_name ASC");
...
<body>
	...
	<section id="content">
		...
		<main>
			...
			<ul class="box-info">
				<li>
					<i><img src="assets/img/materiel.jpg" style="width: 80px; height:80px; border-radius: 50%;"></i>
					<span class="text">
						<h3><?php echo $nbb; ?></h3>
						<p>Ingrédients</p>
					</span>
					...
					<table id="myTable">
                        ...
                        <?php while ($row = $stock->fetch(PDO::FETCH_ASSOC)) :?>
							<tr>
								...
								<td><span class="status pending"><?php echo $row['qty'];?></span></td>
